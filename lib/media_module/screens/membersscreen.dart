...
import 'package:hacker_rank_final/media_module/Models/MemeberModel.dart';

class MembersScreen extends StatefulWidget {
  final bool isAdmin;

  const MembersScreen({super.key, required this.isAdmin});
...
class _MembersScreenState extends State<MembersScreen> {
  ...
  Future<void> showEditScoreDialog(BuildContext context, int index) async {
    ...
    int? newScore = await showDialog<int>(
      ...
      builder: (BuildContext context) {
        ...
        return AlertDialog(
          title: const Text('Edit Score', style: TextStyle(color: Color.fromARGB(255, 50, 116, 52))),
          content: TextField(
  ...
  Future<void> showRemoveMemberDialog(BuildContext context, int index) async {
    ...
    bool? shouldRemove = await showDialog<bool>(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          title: const Text('Remove Member', style: TextStyle(color: Color.fromARGB(255, 159, 23, 23))),
