...
import 'package:hacker_rank_final/pr_module/widgets/Taskwidgets/submission.dart';
...
class TaskScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Consumer<ProviderPRService>(
...
class AddTaskState extends State<AddTask> {
  ...
  void _addTask(BuildContext context) {
    final provider = Provider.of<ProviderPRService>(context, listen: false);
    final newTask = Task(
      name: TaskName,
...
class _TaskBottomSheetState extends State<TaskBottomSheet> {
  ...
  void _updateTask(BuildContext context) {
    ...
    Provider.of<ProviderPRService>(context, listen: false)
        .updateTask(widget.index, updatedTask);
    Navigator.pop(context);
  }

  void _deleteTask(BuildContext context) {
    Provider.of<ProviderPRService>(context, listen: false).deleteTask(widget.index);
